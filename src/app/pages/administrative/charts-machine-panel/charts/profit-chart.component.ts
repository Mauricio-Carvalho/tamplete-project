...
@Component({
  selector: 'ngx-profit-machine-chart',
  styleUrls: ['./charts-common.component.scss'],
  template: `
    <div echarts [options]="options" class="echart" (chartInit)="onChartInit($event)"></div>
  `,
})
export class ProfitMachineChartComponent implements AfterViewInit, OnDestroy, OnChanges {
  ...
  setOptions(eTheme) {
    this.options = {
      ...
      xAxis: [
        {
          type: 'category',
          data: this.profitChartData.chartLabel,  // Datas do gráfico
          axisTick: {
            alignWithLabel: true,
          },
          axisLine: {
      ...
      series: [
        ...
        },
        {
          ...
          data: this.profitChartData.data[1],  // Dados de S500
        },
        {
          name: 'Total',
          type: 'bar',
          ...
          data: this.profitChartData.data[2],  // Dados de Total (S10 + S500)
        },
      ],
    };
  }
